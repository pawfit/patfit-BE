...
public class PawfitCustomerExceptionHandler {

    private static final String MINIREAD_API_EXCEPTION_LOG = "[PawfitCustomerException] : {}";
    ...
    @ExceptionHandler
    public ResponseEntity<PawfitResponse<Void>> handlePawfitCustomerException(PawfitException ex) {

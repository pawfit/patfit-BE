...
public class DesignerController {
    ...
    public UpdateDesignerAccountResponse updateDesignerAccount(@PathVariable Long userId,
                                                               @RequestBody UpdateDesignerAccountRequest request) {
    ...
    public CreateDesignerWorkspaceResponse createDesignerWorkspace(@PathVariable Long userId,
                                                                   @RequestBody CreateDesignerWorkspaceRequest request) {
    ...
    public UpdateDesignerWorkspaceResponse updateDesignerWorkspace(
            @PathVariable Long userId,
            @RequestBody UpdateDesignerWorkspaceRequest request) {

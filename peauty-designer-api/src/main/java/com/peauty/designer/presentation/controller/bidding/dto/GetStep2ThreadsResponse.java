...
public record GetStep2ThreadsResponse(
        @Schema(description = "스레드 목록")
        List<GetStep2ThreadsResponseThread> threads
) {

    @Builder
    public record GetStep2ThreadsResponseThread(
            ...
            GetStep2ThreadsResponsePuppy puppy
    ) {
    }

    @Builder
    public record GetStep2ThreadsResponsePuppy(
    ...
    public static GetStep2ThreadsResponse from(GetThreadsByStepResult result) {
        return new GetStep2ThreadsResponse(
                result.threads().stream()
                        .map(thread -> GetStep2ThreadsResponseThread.builder()
                                ...
                                .puppy(GetStep2ThreadsResponsePuppy.builder()

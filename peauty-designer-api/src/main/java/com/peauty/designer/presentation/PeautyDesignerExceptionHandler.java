...
public class PeautyDesignerExceptionHandler {

    private static final String Peauty_API_EXCEPTION_LOG = "[PeautyDesignerException] : {}";
    ...
    @ExceptionHandler
    public ResponseEntity<PeautyApiResponse<Void>> handlePeautyDesignerException(PeautyException ex) {

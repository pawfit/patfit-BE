...
public class PeautyPaymentExceptionHandler {

    private static final String Peauty_API_EXCEPTION_LOG = "[PeautyPaymentException] : {}";
    ...
    @ExceptionHandler
    public ResponseEntity<PeautyApiResponse<Void>> handlePeautyPaymentException(PeautyException ex) {

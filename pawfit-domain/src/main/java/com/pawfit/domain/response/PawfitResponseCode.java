...
@Getter
@AllArgsConstructor
public enum PawfitResponseCode {
    ...
    public static PawfitResponseCode lookupResponseCode(String code) {
        for (PawfitResponseCode pawfitResponseCode : values()) {
            if (pawfitResponseCode.getCode().equals(code)) {

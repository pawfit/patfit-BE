...
public record GetCanReviewThreadsResponse(
    ...
    public static GetCanReviewThreadsResponse from(GetAllStep3AboveThreadsResult result) {
        return new GetCanReviewThreadsResponse(
                result.threads().stream()
                        .map(thread -> GetAllStep3AboveThreadsResponseThread.builder()
                                .puppyId(thread.puppyId())
